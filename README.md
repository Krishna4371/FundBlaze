...
- 💳 **Dual payment gateway** — Razorpay (India-first, ₹) and Stripe (international, $) with webhook signature verification, idempotency keys, and full audit trails via a dedicated `transactions` collection
