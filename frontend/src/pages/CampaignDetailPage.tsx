...
export function CampaignDetailPage() {
  ...
  const { data: donationsData, isLoading: donationsLoading } = useCampaignDonations(slug!)
          ...
          <div className="lg:sticky lg:top-24 space-y-4">
            ...
            <div className="rounded-2xl border border-white/8 bg-white/[0.03] p-5">
              <div className="mb-4">
                ...
                <div className="flex items-center justify-between mt-2 text-xs text-text-muted">
                  ...
                  <span>₹{(campaign.goalAmount - campaign.raisedAmount).toLocaleString('en-IN')} to go</span>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-white/8 bg-white/[0.03] p-5">
              ...
              <div className="flex items-start gap-3 mb-4">
                <Avatar src={campaign.creator.avatar} fallback={campaign.creator.name} size="lg" online={campaign.creator.verified} />
              ...
              <div className="grid grid-cols-2 gap-3 mb-4 text-center text-xs">
                <div className="rounded-lg bg-white/[0.03] border border-white/8 py-2">
                  <p className="font-bold text-white">{formatDate(campaign.creator.joinedAt)}</p>
                  <p className="text-text-muted">Joined FundBlaze</p>
                </div>
                <div className="rounded-lg bg-white/[0.03] border border-white/8 py-2">
                  <p className="font-bold text-white">{campaign.creator.totalCampaigns} Projects</p>
                  <p className="text-text-muted">Total Campaigns</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-white/8 bg-white/[0.03] p-5">
                ...
                <div className="space-y-3">
                  {campaign.rewardTiers.map(tier => (
                    <div key={tier.id} className="rounded-xl border border-white/8 p-4 hover:border-primary/30 transition-colors cursor-pointer">
