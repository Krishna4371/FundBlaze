  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        coverImage: coverPreview || 'https://images.unsplash.com/photo-1508193638397-1c4234db14d8?w=800&q=80',
        tags: [],
      }
                    ...
                    <label className={cn(
                      ...
                      {coverPreview ? (
                        <div className="relative aspect-video">
                          ...
                          <button type="button" onClick={(e) => { e.preventDefault(); setCoverPreview('') }}
